...
public class Menu extends javax.swing.JPanel {
    ...
    private void initMenu() {
        ...
        addMenu("Clock", "4", 3);
        addMenu("Take note", "5", 4);
        addMenu("School timetable", "6", 5);
        addMenu("Setting", "7", 6);
    ...
    private void addMenu(String menuName, String icon, int index) {
        ...
        m.setIcoName(icon);
        m.setIcon(new ImageIcon(getClass().getResource("/com/pbl/icon/" + icon + ".png")));
        ...
        m.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                if (index == 10) {  // với menu “Take note” (ở vị trí 5)
                    clearSelected();
                    selectedIndex = index;
        ...
        for (Component com : menu.getComponents()) {
            if (com instanceof MenuButton) {
                ...
                if (!c.getIcoName().contains("_s")) {
                    c.setIcon(new ImageIcon(getClass().getResource("/com/pbl/icon/" + c.getIcoName() + ".png")));
                }
            }
        }
    }
    ...
    public void setSelectedMenu(int index) {
        ...
        cmd.setIcon(new ImageIcon(getClass().getResource("/com/pbl/icon/" + cmd.getIcoName() + "_s.png")));
    }
    ...
    private void initComponents() {
        ...
        imageAvatar1 = new com.pbl.theme.ImageAvatar();
        ...
        imageAvatar1.setImage(new javax.swing.ImageIcon(getClass().getResource("/com/pbl/icon/OIP (9).jpg"))); // NOI18N
    ...
    private com.pbl.theme.ImageAvatar imageAvatar1;
